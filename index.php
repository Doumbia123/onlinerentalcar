...
<head>
    ...
    <!--Font awsome icon package-->
    <link rel="stylesheet" href="vendor/node_modules/@fortawesome/fontawesome-free/css/all.css" crossorigin="anonymous">
    <!--Font awsome icon package end-->
    <!--animate package-->
    <link rel="stylesheet" href="vendor/node_modules/animate.css/animate.css">
    <!--animate package end-->
...
<nav class="navbar navbar-light bg-light">
    <div class="container">
        ...
        <ul class="nav justify-content-end">
            <li class="nav-item">
                <a class="nav-link active text-decoration-none" href="#">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-decoration-none" href="#">About</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-decoration-none" href="#">Cars</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-decoration-none" href="#">Contact</a>
            </li>
    ...
    <div class="row">
        <div class="container">
            <div class="row" style="margin-top:10%;">
                <div class="col-sm-6">
                    <h1 class="mainSectionTitle">CHEAP CAR RENTAL IN YOUR DESIRED DESTINATION</h1>
                    <p class="" style="color: white;">One of our top priorities is to adjust each package we offer to our
                        customer’s exact needs. Rental Cars / Jeeps Starting Rs 1000 / Days</p>
                </div>
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="#" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="City, Airport, Station,etc">
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput2">DROP-OFF LOCATION</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="City, Airport, Station,etc">
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">DROP-OFF DATE</label>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 serviceoffercolor" style="border-right: #F9F9F9 solid 2px;">

            <h3><i class="fas fa-globe-africa i"></i> &nbsp; 24 / 7 CAR SUPPORT</h3>
            <br>
        ...
        <div class="col-sm-3 serviceoffercolor" style="border-right: #F9F9F9 solid 2px;">
             <h3><i class="fas fa-globe-africa i"></i> &nbsp; LOTS OF LOCATION</h3>
            <br>
            <p>Proin gravida nibh vel velit auctor
                aliquet. Aenean sollicitudin, lorem
                quis bibendum auctor.</p>
        ...
        <div class="col-sm-3 serviceoffercolor" style="border-right: #F9F9F9 solid 2px;">
             <h3><i class="fas fa-clipboard-list i" ></i> &nbsp; RESERVATION ANYTIME</h3>
            <br>
            <p>Proin gravida nibh vel velit auctor
                aliquet. Aenean sollicitudin, lorem
                quis bibendum auctor.</p>
        </div>
        <div class="col-sm-3 serviceoffercolor" >
             <h3><i class="fas fa-car-side i"></i> &nbsp; RENTAL CARS</h3>
            <br>
            <p>Proin gravida nibh vel velit auctor
                aliquet. Aenean sollicitudin, lorem
                quis bibendum auctor.</p>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="vendor/node_modules/bootstrap/dist/js/bootstrap.min.js"
